...
\renewcommand{\subtitle}{Resume for a PhD application}
\renewcommand{\phone}{***REMOVED***}
\renewcommand{\email}{elie.genard@phelma.grenoble-inp.fr}
\renewcommand{\adress}{***REMOVED***}
\renewcommand{\city}{***REMOVED***}
...
\begin{body}
	\experience
		...
		\end{entry}
		\begin{entry}
			{June-September 2013}{Internship as an engineer assistant}{Grenoble}
			{Movea}
	...
	\education
		\begin{entry}
			...
			~~~~{\itshape [~code available at \href{https://github.com/elaye/AST\_diabolo\_particles}{https://github.com/elaye/AST\_diabolo\_particles}~]}
			\medskip\\
